...
ROW_RULES = (
    # 冰洗 3–13
    RowRule(3, ("冰箱",), ("海尔",), ("冰箱",), ("海尔",)),
    RowRule(4, ("洗衣机",), ("海尔",), ("洗衣机",), ("海尔",)),
    RowRule(5, ("冰箱",), ("美的", "东芝"), ("冰箱",), ("美的",)),
    RowRule(6, ("洗衣机",), ("美的",), ("洗衣机",), ("美的",)),
    ...
    RowRule(17, ("国产彩电",), ("海尔",), ("电视",), ("海尔",)),
    RowRule(18, ("国产彩电",), ("华为",), ("电视",), ("华为",)),
    # 空调 19–25
    RowRule(19, ("空调",), ("格力",), ("空调",), ("格力",)),
    RowRule(20, ("空调",), ("美的",), ("空调",), ("美的",)),
    RowRule(21, ("空调",), ("海尔",), ("空调",), ("海尔",)),
    ...
    RowRule(28, ("厨卫",), ("AO史密斯",), ("厨卫",), ("AO史密斯",)),
    RowRule(29, ("厨卫",), ("海尔",), ("厨卫",), ("海尔",)),
    RowRule(30, ("厨卫",), ("美的",), ("厨卫",), ("美的",)),
...
BRAND_GROUP_RULES = (
    BrandGroupRule(
        ...
        "海尔系",
        (
            BrandGroupCategory("冰箱", "冰箱", ("海尔",)),
            BrandGroupCategory("洗衣机", "洗衣机", ("海尔",)),
            BrandGroupCategory("国产彩电", "电视", ("海尔",)),
            BrandGroupCategory("空调", "空调", ("海尔",)),
            BrandGroupCategory("厨卫", "厨卫", ("海尔",)),
        ),
    ),
    BrandGroupRule(
        41,
        "美的系",
        (
            BrandGroupCategory("冰箱", "冰箱", ("美的", "东芝")),
            BrandGroupCategory("洗衣机", "洗衣机", ("美的",)),
            BrandGroupCategory("空调", "空调", ("美的",)),
            BrandGroupCategory("厨卫", "厨卫", ("美的",)),
        ),
    ),
